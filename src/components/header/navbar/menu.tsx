  ...
  return (
    <div className={"offcanvas offcanvas-end"} id={"offcanvasNavbar"} tabIndex={-1}>
      <div className={"offcanvas-header"}>
        ...
        <button aria-label={"Close"} className={"btn-close"} data-bs-dismiss={"offcanvas"} type={"button"}></button>
      </div>
      <div className={"offcanvas-body"}>
        ...
        <form className={"d-flex mt-3"} role={"search"}>
          <input aria-label={"Search"} className={"form-control me-2"} type="search" placeholder="Rechercher..." />
